...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ar": {
        ...
        "err_invalid_format": "❌ صيغة غير صحيحة!",
        # Channel main menu
        ...
        "btn_dashboard": "📊 لوحة التحكم (Dashboard)",
        "btn_automation": "🤖 الأتمتة الذكية",
        "btn_sync_engine": "🔄 محرك المزامنة",
        "btn_monitoring": "🩺 المراقبة والصحة",
        "btn_advanced_op": "⚙️ عمليات متقدمة",
        "btn_ch_health_check": "🩺 فحص صحة القناة الآن",
        "btn_ch_sync_now": "🔄 بدء المزامنة فوراً",
        "btn_ch_tags_categories": "🏷️ التصنيفات والعلامات",
        "btn_bulk_test": "🩺 فحص الاتصال الجماعي",
        "btn_bulk_sync": "🔄 مزامنة جماعية",
        "btn_bulk_fix": "🛠️ إصلاح تلقائي للمشاكل",
        "ch_dashboard_title": "📊 لوحة التحكم المؤسسية للقناة: {name}",
        "ch_dashboard_body": (
            "مرحباً بك في لوحة تحكم القناة.\n"
            "حالة القناة: {status}\n"
            "آخر مزامنة: {last_sync}\n\n"
            "اختر إحدى الأدوات المتقدمة لإدارة قناتك باحترافية."
        ),
        "ch_sync_running": "🔄 جاري تشغيل المزامنة للقناة...",
        "ch_health_running": "🩺 جاري فحص صحة القناة والمشرفين...",
        "ch_bulk_ops_title": "⚙️ العمليات الجماعية",
        "ch_bulk_ops_body": "اختر عملية لتطبيقها على جميع قنواتك بضغطة واحدة.",
        # Channel list
        "no_channels": (
        ...
        "btn_prot_join_filters": "🚫 فلاتر الانضمام للمجموعة",
        "btn_prot_anti_links": "🔗 حظر الروابط: {state}",
        "btn_prot_anti_spam": "🛡️ منع السبام: {state}",
        "btn_prot_banned_words": "🗑️ الكلمات المحظورة",
        "btn_prot_punishments": "⚖️ الإجراءات العقابية",
        "btn_prot_warn_1": "1 تحذير",
        "btn_prot_warn_3": "3 تحذيرات",
        "btn_prot_warn_5": "5 تحذيرات",
        "btn_prot_act_mute": "🔇 كتم",
        "btn_prot_act_kick": "👞 طرد",
        "btn_prot_act_ban": "⛔ حظر",
        "prot_punish_title": "⚖️ الإجراءات العقابية\n\nأقصى عدد للتحذيرات: {max_warn}\nالإجراء المتخذ: {action}",
        "prot_action_mute": "كتم",
        "prot_action_kick": "طرد",
        "prot_action_ban": "حظر",
        "prot_warn_msg_link": "⚠️ {user}، يمنع إرسال الروابط! (تحذير {warns}/{max})",
        "prot_warn_msg_word": "⚠️ {user}، يمنع استخدام كلمات محظورة! (تحذير {warns}/{max})",
        "prot_warn_msg_spam": "⚠️ {user}، توقف عن إرسال رسائل مكررة بسرعة! (تحذير {warns}/{max})",
        "prot_punish_applied": "⛔ تم تطبيق عقوبة ({action}) على {user} لتجاوزه الحد المسموح من التحذيرات.",
        "captcha_toggled": "✅ تم تحديث إعداد الكابتشا. الحالة الآن: {state}",
        "captcha_msg": "🤖 مرحباً {user}! لضمان أنك لست بوتاً، يرجى الضغط على الزر أدناه خلال دقيقتين للتمكن من إرسال الرسائل.",
        "btn_captcha_verify": "✅ أنا لست بوتاً",
        "err_not_your_captcha": "❌ هذا الاختبار ليس لك!",
        ...
        # Protection UI
        "btn_prot_join_filters": "🛡️ فلاتر الانضمام",
        "btn_prot_anti_links": "🔗 حظر الروابط: {state}",
        "btn_prot_anti_spam": "📨 منع السبام: {state}",
        "btn_prot_banned_words": "🤬 الكلمات الممنوعة",
        "btn_prot_punishments": "⚙️ العقوبات والتحذيرات",
        "prot_punish_title": "⚙️ **إعدادات العقوبات والتحذيرات**\n\nتحدد هذه الإعدادات ما يحدث للعضو عند مخالفته للقوانين (إرسال روابط، سبام، كلمات ممنوعة).\n\nالحد الأقصى للتحذيرات: {max_warn}\nالإجراء المتخذ: {action}",
        "btn_prot_warn_1": "1️⃣ تحذير واحد",
        "btn_prot_warn_3": "3️⃣ 3 تحذيرات",
        "btn_prot_warn_5": "5️⃣ 5 تحذيرات",
        "btn_prot_act_mute": "🔇 كتم (Mute)",
        "btn_prot_act_kick": "👢 طرد (Kick)",
        "btn_prot_act_ban": "⛔ حظر (Ban)",
        "prot_action_mute": "كتم",
        "prot_action_kick": "طرد",
        "prot_action_ban": "حظر",
        "prot_warn_msg_link": "⚠️ {user}، يمنع إرسال الروابط هنا! (تحذير {warns}/{max})",
        "prot_warn_msg_spam": "⚠️ {user}، يرجى التوقف عن إرسال الرسائل المكررة! (تحذير {warns}/{max})",
        "prot_warn_msg_word": "⚠️ {user}، يرجى احترام قوانين المجموعة وعدم استخدام ألفاظ غير لائقة! (تحذير {warns}/{max})",
        "prot_punish_applied": "🚨 تم تطبيق عقوبة ({action}) على {user} لتجاوزه الحد الأقصى للمخالفات.",
    },
    "en": {
        ...
        # Protection UI
        "btn_prot_join_filters": "🛡️ Join Filters",
        "btn_prot_anti_links": "🔗 Anti-Links: {state}",
        "btn_prot_anti_spam": "📨 Anti-Spam: {state}",
        "btn_prot_banned_words": "🤬 Banned Words",
        "btn_prot_punishments": "⚙️ Punishments & Warnings",
        "prot_punish_title": "⚙️ **Punishments & Warnings**\n\nThese settings define what happens when a member violates the rules (sending links, spam, banned words).\n\nMax warnings: {max_warn}\nAction: {action}",
        "btn_prot_warn_1": "1️⃣ 1 Warning",
        "btn_prot_warn_3": "3️⃣ 3 Warnings",
        "btn_prot_warn_5": "5️⃣ 5 Warnings",
        "btn_prot_act_mute": "🔇 Mute",
        "btn_prot_act_kick": "👢 Kick",
        "btn_prot_act_ban": "⛔ Ban",
        "prot_action_mute": "Mute",
        "prot_action_kick": "Kick",
        "prot_action_ban": "Ban",
        "prot_warn_msg_link": "⚠️ {user}, links are not allowed here! (Warning {warns}/{max})",
        "prot_warn_msg_spam": "⚠️ {user}, please stop sending repeated messages! (Warning {warns}/{max})",
        "prot_warn_msg_word": "⚠️ {user}, please respect group rules and avoid inappropriate words! (Warning {warns}/{max})",
        "prot_punish_applied": "🚨 Applied ({action}) on {user} for exceeding maximum warnings.",
    },
}
